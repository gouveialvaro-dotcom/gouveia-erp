...
create table public."Funcao" (
  ...
  "criadoPorId" uuid references public."Usuario"(id) on delete set null,
...
alter table public."Funcionario"
  add column "funcaoId" uuid references public."Funcao"(id) on delete set null;
...
alter table public."OrcamentoMaoObra"
  add column "funcaoId" uuid not null references public."Funcao"(id) on delete restrict;
